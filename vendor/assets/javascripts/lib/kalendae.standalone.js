...
Kalendae.prototype = {
	...
	setSelected : function (input, draw) {
		...
		i = new_dates.length;
		while(i--) { this.addSelected(new_dates[i], false, false); }
	...
	addSelected : function (date, draw, publishChange) {
    if (publishChange === undefined || publishChange === null) { publishChange = true; }
		...
		if (((this.settings.mode === 'range' && this._sel.length == 2) || this.settings.mode !== 'range') && publishChange) {
